        ...
        {filteredItems.length > 0 ? (
          filteredItems.map((item, index) => {
            ...
            const cardContent = (
              ...
              >
                <Card className="hover:border-primary/50 group overflow-hidden border-white/5 bg-card/20 p-0 transition-all duration-500 hover:bg-card/30 hover:shadow-2xl hover:shadow-primary/5">
